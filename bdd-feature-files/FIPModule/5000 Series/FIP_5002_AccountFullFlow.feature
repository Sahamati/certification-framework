Feature:On calling Full Flow APIs except account discovery and consent notification, Send the account link
  ...
  Scenario: 5001_1 On calling Full Flow APIs, send the request with first account of double account user for
  FIType as DEPOSIT. Verify that the HTTP status code 200 is received in response.
  ...
  Scenario: 5001_2 On calling Full Flow APIs, send the request with two accounts of double account user for
  FIType as DEPOSIT. Verify that the HTTP status code 200 is received in response.
    Given Calling the Full Flow APIs.
    When Full Flow APIs action is performed.
    Then Verify that the reponse code of all APIs is 200.
  ...
  Scenario: 5001_3 On calling Full Flow APIs, send the request with first account of double account user for
  FIType as TERM-DEPOSIT. Verify that the HTTP status code 200 is received in response.
    Given Calling the Full Flow APIs.
    When Full Flow APIs action is performed.
    Then Verify that the reponse code of all APIs is 200.
    And  Verify that the Account link response AuthenticatorType is TOKEN. If TOKEN is not specified in supported
  ...
  Scenario: 5001_4 On calling Full Flow APIs, send the request  with two accounts of double account user for
  FIType as TERM-DEPOSIT. Verify that the HTTP status code 200 is received in response.
    Given Calling the Full Flow APIs.
    When Full Flow APIs action is performed.
    Then Verify that the reponse code of all APIs is 200.
  ...
  Scenario: 5001_5 On calling Full Flow APIs, send the request with first account of double account user for
  FIType as RECURRING_DEPOSIT. Verify that the HTTP status code 200 is received in response.
    Given Calling the Full Flow APIs.
    When Full Flow APIs action is performed.
    Then Verify that the reponse code of all APIs is 200.
    And  Verify that the Account link response AuthenticatorType is TOKEN. If TOKEN is not specified in supported
  ...
  Scenario: 5001_6 On calling Full Flow APIs, send the request with two accounts of double account user for
  FIType as RECURRING_DEPOSIT. Verify that the HTTP status code 200 is received in response.
    Given Calling the Full Flow APIs.
    When Full Flow APIs action is performed.
    Then Verify that the reponse code of all APIs is 200.
